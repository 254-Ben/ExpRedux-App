...
//         expense: {
//             id: uuid(),
//             description: expense.description ? expense.description: '', note: expense.note ? expense.note:'',
...
// store.dispatch(editExpense(expenseTwo.expense.id,{description: 'achwaka'}));
